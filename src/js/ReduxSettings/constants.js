export const actionNames = {
    ...
    SET_MAX_PRICE_RANGE: 'SET_MAX_PRICE',
    SET_MIN_PRICE_RANGE: 'SET_MIN_PRICE',
    RESET_PRICES_RANGES: 'RESET_PRICE_RANGES',
    ...
    CHANGE_FAVORITE_PROPERTY: 'CHANGE_FAVORITE_PROPERTY'
};
